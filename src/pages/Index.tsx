...
const categories = [
  { name: "Groceries", icon: ShoppingBasket, itemCount: 3 },
  { name: "Electronics", icon: Laptop, itemCount: 3 },
  { name: "Fashion", icon: Shirt, itemCount: 3 },
  { name: "Home", icon: Home, itemCount: 3 },
];
